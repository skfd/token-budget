...
/// <summary>
/// Reads real-time statusline data from ~/.qwen/widget-data.json.
...
public sealed class StatuslineReader
{
    ...
    public StatuslineReader()
    {
        ...
        _statusFilePath = Path.Combine(userProfile, ".qwen", "widget-data.json");
    }
    ...
    public StatuslineData? Read()
    {
        ...
        // Check file age — if > 5 minutes old, Qwen app probably isn't running
